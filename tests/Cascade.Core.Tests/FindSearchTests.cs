...
public class FindSearchTests
{
    ...
    private sealed class Fake
    {
        ...
        public void Scan(long from, long count, FindHits hits, CancellationToken ct)
        {
    ...
    {
        var search = new FindSearch(Q, 1000, 0, (long _, long _, FindHits _, CancellationToken _)
